...
const nextConfig: NextConfig = {
  ...
  images: {
    ...
    // Evita timeouts de otimização em dev usando a imagem original (sem proxy)
    unoptimized: process.env.NODE_ENV === 'development' || process.env.NEXT_IMAGE_UNOPTIMIZED === 'true',
  },
